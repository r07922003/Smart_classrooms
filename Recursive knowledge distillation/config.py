...
config.ce_loss = True
config.fc7_lr_mult = 0.8
config.fc7_wd_mult = 0.8
...
#teacher settings
config.teacher_prefix = '/home/nealson/insightface/recognition/teachermodel/resnet100/model'
config.teacher_epoch = 1
config.teacher_symbol = 'fc1_output'
...
dataset.emore.dataset_path = '/home/nealson/datasets/faces_emore_2'
...
default.lr = 0.004 #0.003 #0.01 loss14
default.wd = 0.001
default.mom = 0.9
default.per_batch_size = 120
default.ckpt = 3
default.lr_steps = '200000,240000,280000'
